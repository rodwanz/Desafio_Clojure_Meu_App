...
var i_12802 = (0);
while(true){
if((i_12802 < arr.length)){
(arr[i_12802] = null);

var G__12805 = (i_12802 + (1));
i_12802 = G__12805;
continue;
} else {
}
...
var i_12829 = (self__.level + (1));
while(true){
if((i_12829 <= (new_level + (1)))){
(update[i_12829] = self__.header);

var G__12838 = (i_12829 + (1));
i_12829 = G__12838;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_12841 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_12841[i]));
} else {
x__$2.forward.push((((i < links_12841.length))?(links_12841[i]):null));
}

if((i < links_12841.length)){
(links_12841[i] = x__$2);
} else {
links_12841.push(x__$2);
}
...
var i_12867 = (0);
while(true){
if((i_12867 <= self__.level)){
var links_12869 = (update[i_12867]).forward;
if((x__$1 === (((i_12867 < links_12869.length))?(links_12869[i_12867]):null))){
(links_12869[i_12867] = (x__$1.forward[i_12867]));

var G__12875 = (i_12867 + (1));
i_12867 = G__12875;
continue;
} else {
var G__12877 = (i_12867 + (1));
i_12867 = G__12877;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__12900 = nx;
var G__12901 = (level__$1 - (1));
x = G__12900;
level__$1 = G__12901;
continue;
} else {
var G__12902 = x;
var G__12903 = (level__$1 - (1));
x = G__12902;
level__$1 = G__12903;
continue;
}
