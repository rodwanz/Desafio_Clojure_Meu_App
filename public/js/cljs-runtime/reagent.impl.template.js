...
return (function() { 
var G__21957__delegate = function (args){
...
while (G__21958__i < G__21958__a.length) {G__21958__a[G__21958__i] = arguments[G__21958__i + 0]; ++G__21958__i;}
  args = new cljs.core.IndexedSeq(G__21958__a,0,null);
} 
return G__21957__delegate.call(this,args);};
G__21957.cljs$lang$maxFixedArity = 0;
G__21957.cljs$lang$applyTo = (function (arglist__21959){
var args = cljs.core.seq(arglist__21959);
return G__21957__delegate(args);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21962__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21963__i < G__21963__a.length) {G__21963__a[G__21963__i] = arguments[G__21963__i + 0]; ++G__21963__i;}
  args = new cljs.core.IndexedSeq(G__21963__a,0,null);
} 
return G__21962__delegate.call(this,args);};
G__21962.cljs$lang$maxFixedArity = 0;
G__21962.cljs$lang$applyTo = (function (arglist__21964){
var args = cljs.core.seq(arglist__21964);
return G__21962__delegate(args);
});
...
var temp__5808__auto___21974 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___21979 = reagent.impl.util.react_key_from_vec(argv);
...
var temp__5808__auto___21992 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21992 == null)){
} else {
var key_21993 = temp__5808__auto___21992;
...
break;
default:
var G__21997 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21998 = compiler;
v = G__21997;
compiler = G__21998;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21954 = (function (opts,id,fn_to_element,parse_fn,meta21955){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21954.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21956,meta21955__$1){
var self__ = this;
var _21956__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21954(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21955__$1));
}));

(reagent.impl.template.t_reagent$impl$template21954.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21956){
var self__ = this;
var _21956__$1 = this;
return self__.meta21955;
}));

(reagent.impl.template.t_reagent$impl$template21954.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21954.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21954.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21954.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21954.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21954.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21955","meta21955",1542684697,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21954.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21954.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21954");

(reagent.impl.template.t_reagent$impl$template21954.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template21954");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21954.
 */
reagent.impl.template.__GT_t_reagent$impl$template21954 = (function reagent$impl$template$__GT_t_reagent$impl$template21954(opts,id,fn_to_element,parse_fn,meta21955){
return (new reagent.impl.template.t_reagent$impl$template21954(opts,id,fn_to_element,parse_fn,meta21955));
});
...
return (new reagent.impl.template.t_reagent$impl$template21954(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
